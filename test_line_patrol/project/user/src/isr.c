...
//		Motor_Control(SpeedMode.stop);
		...
		oscilloscope_data.data[0] = 50;
		oscilloscope_data.data[1] = encoder_rear_L;
		oscilloscope_data.data[2] = encoder_rear_R;
		oscilloscope_data.data[3] = encoder_front_L;
		oscilloscope_data.data[4] = encoder_front_R;
		// 通过串口发送到虚拟示波器上
